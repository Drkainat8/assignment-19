...
let guestlist :string[] = ['hina' , 'tooba' , 'fatima', 'kainat', 'ali', 'hadi']
...
if (removedguestlist!==undefined) {
   console.log(`sorry ${removedguestlist} we can't invite you for a dinner`)
}
}
//tell the remaining 2 guest that you are still invted for dinner 
guestlist.forEach(invitation => {
    console.log(`dear ${invitation} you are still invited for dinner`)
});
